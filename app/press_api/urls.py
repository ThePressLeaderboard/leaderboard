...
urlpatterns = [
    ...
    path('section/<str:section_name>/journalist', SectionJournallistRanking.as_view(), name='setionjournalistranking'),
    path('journalist', JournalistRanking.as_view(), name='journalistranking'),
    path('journalist/<int:journalist_id>', JournalistDetail.as_view(), name='journalistdetail')
]