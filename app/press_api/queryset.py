...
category_query_set = Category.objects.annotate(
            ...
            ),subscriber_count=Sum('press__journalist__subscriber_count'), cheer_count=Sum('press__journalist__cheer_count')
        )
...
Press_query_set = Press.objects.annotate(
            ...
            ),subscriber_count=Sum('journalist__subscriber_count'), cheer_count=Sum('journalist__cheer_count')
        )

secion_query_set = Section.objects.annotate(
            male_subscriber=Sum(
                F('journalistsection__journalist__subscriber_count') * F('journalistsection__journalist__gender__percentage') / 100,
            ...
            ),subscriber_count=Sum('journalistsection__journalist__subscriber_count'), cheer_count=Sum('journalistsection__journalist__cheer_count')
        )
